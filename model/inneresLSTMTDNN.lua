local inneresLSTMTDNN = {}

local ok, cunn = pcall(require, 'fbcunn')
LookupTable = nn.LookupTable

function inneresLSTMTDNN.innereslstmtdnn(rnn_size, n, dropout, word_vocab_size, word_vec_size, char_vocab_size, char_vec_size,
    ...
    local i2h = ResMLP.mlp(input_size_L, highway_layers)(x)
    --local h2h = ResMLP.mlp(rnn_size, highway_layers)(prev_h)
	local h2h = nn.Linear(rnn_size, 4 * rnn_size)(prev_h)
